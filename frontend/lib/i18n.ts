export const translations = {
  en: {
    ...
    upload: {
      ...
      uploading: 'Uploading...',
      orLoadDemo: 'or load a demo dataset',
      demoDatasets: 'Demo Datasets',
      paul15: 'Paul15 (Hematopoiesis)',
      paul15Desc: 'Mouse bone marrow cells - hematopoietic differentiation',
      pbmc3k: 'PBMC 3k',
      pbmc3kDesc: '3000 peripheral blood mononuclear cells',
      simulationBifurcation: 'Bifurcation Simulation',
      simulationBifurcationDesc: 'Simulated data with two-branch structure',
      simulationTree: 'Tree Simulation',
      simulationTreeDesc: 'Simulated data with tree-like multi-branch structure',
  ...
  zh: {
    ...
    upload: {
      ...
      demoDatasets: '演示数据集',
      paul15: 'Paul15（造血分化）',
      paul15Desc: '小鼠骨髓细胞 - 造血分化过程',
      pbmc3k: 'PBMC 3k',
      pbmc3kDesc: '3000个外周血单核细胞',
      simulationBifurcation: '分叉模拟数据',
      simulationBifurcationDesc: '具有双分支结构的模拟数据',
      simulationTree: '树状模拟数据',
      simulationTreeDesc: '具有树状多分支结构的模拟数据',
      loadingDemo: '加载演示数据中...',
    },
